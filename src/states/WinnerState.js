class WinnerState extends Phaser.State {
    ...
    preload() {
        ...
        this.game.load.atlasXML('hero3', 'assets/sprites/pose_m.png', 'assets/sprites/pose_m.xml');
    ...
    create() {
        ...
        if (this.hero == 1) {
            ...
            let animhero = this.game.add.sprite(this.game.world.centerX - 200, 50, 'hero3');
            animhero.animations.add('default');
            animhero.animations.play('default', 30, true);
