...
class SkillFactory {
    static createSkill(name) {
        if (name == 'FaithPunch') {
            return new Skill('FaithPunch', 19, [[0, 0, 0], [2, 0, 0], [1, 0, 0]], 'A', {attackValue: 2});
        } else if (name == 'SaintHeal') {
            return new Skill('SaintHeal', 13, [[0, 0, 3], [0, 3, 3], [0, 0, 0]], 'H', {healValue: 2});
            ...
            return new Skill('FaithRitual', 14, [[2, 0, 2], [0, 1, 0], [0, 0, 2]], 'A', {attackValue: 5});
        }
    }
}
